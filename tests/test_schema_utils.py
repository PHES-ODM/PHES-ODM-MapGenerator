...
def test_get_slot_definition_no_exception_returns_none(schema):
    result = get_slot_definition("Sample", "nonexistent", schema, exception_on_error=False)
...
def test_add_ontoid_to_enum_value_no_pattern(schema):
    result = add_ontoid_to_enum_value(schema, "CollectionDeviceEnum", "swab", match_ontology_id=None)
    assert result == "swab"

def test_add_ontoid_to_enum_value_no_enum_name(schema):
    result = add_ontoid_to_enum_value(schema, "", "swab", match_ontology_id=r"\s*\[.*?\]")
    assert result == "swab"

def test_add_ontoid_to_enum_value_nonexistent_enum(schema):
    result = add_ontoid_to_enum_value(schema, "FakeEnum", "swab", match_ontology_id=r"\s*\[.*?\]")
    assert result == "swab"

def test_add_ontoid_to_enum_value_no_match(schema):
    result = add_ontoid_to_enum_value(schema, "CollectionDeviceEnum", "unknown", match_ontology_id=r"\s*\[.*?\]")
...
def test_add_ontoid_to_enum_value_match_returns_full_value(ontoid_schema):
    ...
    result = add_ontoid_to_enum_value(ontoid_schema, "DeviceEnum", "swab", match_ontology_id=r"\s*\[.*?\]")
...
def test_get_permissible_values_from_enum_names_sorted(schema):
    values = get_permissible_values_from_enum_names(["CollectionDeviceEnum"], schema, sort_values=True)
    assert values == sorted(values, key=str.lower)

def test_get_permissible_values_from_enum_names_multiple_enums(schema):
    values = get_permissible_values_from_enum_names(["CollectionDeviceEnum", "StatusEnum"], schema)
