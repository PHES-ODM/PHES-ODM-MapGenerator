...
def prepare_parts(
    parts_file: str, output_file: str, map_columns: Optional[Dict[str, str]] = None
):
...
if __name__ == "__main__":
    if "get_ipython" in globals():
        ...
        args.add_argument(
            "--parts_file",
            type=str,
            help="Input CSV ODM v2 parts file to prepare for v1 to v2 mapping",
            required=True,
        )
        args.add_argument(
            "--output_file",
            type=str,
            help="CSV file to save the prepared file to",
            required=True,
        )
