...
| [Data Validator](data-validator.md) | `validate.py` — validating a CSV/TSV data file against a LinkML schema |
| [YAML to XLSX Mapper](yaml-to-xlsx-mapper.md) | `yaml_to_xlsx_mapper.py` — reverse-engineering mappers into a bootstrap workbook |
