...
def test_choose_ignore_case_value_not_found_returns_none():
    result = choose_ignore_case_value("missing", ["Hello"], return_same_if_missing=False)
...
def test_choose_ignore_case_value_precomputed_lowercase():
    ...
    result = choose_ignore_case_value("ALPHA", allowable, lowercase_allowable_values=lower)
    assert result == "Alpha"
