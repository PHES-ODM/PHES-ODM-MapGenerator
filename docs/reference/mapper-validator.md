...
[make_mappers_cli.py](cli-config-files.md#odm-v1-to-odm). Run `make_mappers_cli.py`
...
Validates mappers generated by
[make_mappers_cli.py](cli-config-files.md#nwss-to-odm). Three NWSS dictionary
types are supported: `reporting`, `public_concentration`, and `public_metric`.
Substitute the dictionary type name into the paths as shown below.
...
Validates mappers generated by
[make_mappers_cli.py](cli-config-files.md#pha4ge-to-odm).
