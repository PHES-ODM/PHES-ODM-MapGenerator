...
by [make_mappers_cli.py](README.md). It checks that every enumeration mapping is
complete, consistent, and free of typos — catching problems that would otherwise
silently produce incorrect data transformations.
